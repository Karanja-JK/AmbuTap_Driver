...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("AmbuTap_Driver.Helpers.LocationCallbackHelper, AmbuTap Driver", LocationCallbackHelper.class, __md_methods);
	}
	...
	public LocationCallbackHelper ()
	{
		...
		if (getClass () == LocationCallbackHelper.class)
			mono.android.TypeManager.Activate ("AmbuTap_Driver.Helpers.LocationCallbackHelper, AmbuTap Driver", "", this, new java.lang.Object[] {  });
	}
