...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("AmbuTap_Driver.EventListener.TaskCompletionListener, AmbuTap Driver", TaskCompletionListener.class, __md_methods);
	}
	...
	public TaskCompletionListener ()
	{
		...
		if (getClass () == TaskCompletionListener.class)
			mono.android.TypeManager.Activate ("AmbuTap_Driver.EventListener.TaskCompletionListener, AmbuTap Driver", "", this, new java.lang.Object[] {  });
	}
