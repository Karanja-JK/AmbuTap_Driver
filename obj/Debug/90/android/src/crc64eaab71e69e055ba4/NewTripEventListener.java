...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("AmbuTap_Driver.EventListener.NewTripEventListener, AmbuTap Driver", NewTripEventListener.class, __md_methods);
	}


	public NewTripEventListener ()
	{
		super ();
		if (getClass () == NewTripEventListener.class)
			mono.android.TypeManager.Activate ("AmbuTap_Driver.EventListener.NewTripEventListener, AmbuTap Driver", "", this, new java.lang.Object[] {  });
	}

	public NewTripEventListener (java.lang.String p0, android.location.Location p1)
	{
		super ();
		if (getClass () == NewTripEventListener.class)
			mono.android.TypeManager.Activate ("AmbuTap_Driver.EventListener.NewTripEventListener, AmbuTap Driver", "System.String, mscorlib:Android.Locations.Location, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}
