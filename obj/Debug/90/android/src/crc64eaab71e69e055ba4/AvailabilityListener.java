...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("AmbuTap_Driver.EventListener.AvailabilityListener, AmbuTap Driver", AvailabilityListener.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == AvailabilityListener.class)
			mono.android.TypeManager.Activate ("AmbuTap_Driver.EventListener.AvailabilityListener, AmbuTap Driver", "", this, new java.lang.Object[] {  });
	}
